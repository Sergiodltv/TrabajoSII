CREATE TABLE ALUMNO (ID INTEGER NOT NULL, apellido_1 VARCHAR NOT NULL, APELLIDO2 VARCHAR, CODIGOPOSTAL INTEGER, contrasenya VARCHAR NOT NULL, DIRECCION VARCHAR, dni VARCHAR NOT NULL UNIQUE, email_institucional VARCHAR NOT NULL, EMAILPERSONAL VARCHAR, LOCALIDAD VARCHAR, MOVIL INTEGER, nombre VARCHAR NOT NULL, PROVINCIA VARCHAR, TELEFONO INTEGER, PRIMARY KEY (ID))
CREATE TABLE ASIGNATURA (REFERENCIA INTEGER NOT NULL, codigo INTEGER NOT NULL, creditospr INTEGER NOT NULL, creditosteo INTEGER NOT NULL, CURSO INTEGER, DURACION VARCHAR, INGLES VARCHAR, nombre VARCHAR NOT NULL, ofertada VARCHAR NOT NULL, PLAZAS VARCHAR, totalcreditos INTEGER NOT NULL, UNIDADTEMPORAL INTEGER, AS_TITUL_CODIGO INTEGER NOT NULL, PRIMARY KEY (REFERENCIA))
...
CREATE TABLE EXPEDIENTE (NUMEXPEDIENTE INTEGER NOT NULL, ACTIVO BOOLEAN, NOTAMEDIAPROVISIONAL DOUBLE, AL_EXP_ID INTEGER NOT NULL, PRIMARY KEY (NUMEXPEDIENTE))
